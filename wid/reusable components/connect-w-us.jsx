...
const Connect = () => {
  return (
    <section className="text-white py-[100px] bg-[#0673EF]">
        <h3 className="text-[32px] font-[600] text-center wow fadeInDown mb-[16px]">Connect with Us</h3>
        <p className="text-[16px] text-center max-w-[455px] wow fadeIn mb-[40px] w-[40%] mx-auto font-[400] leading-[24px]">Subscribe to monthly newsletter and stay updated on major developments about Women in Defi.</p>
