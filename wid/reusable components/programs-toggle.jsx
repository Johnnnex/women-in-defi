    ...
    return (
      <section className="max-w-[1272px] pt-[67px] pb-[110px] w-[90%] md:w-[85%] mx-auto">
          ...
          <section className={`${events != "one" ? "hidden" : ""}`}>
            <h3 className="text-[#110138] wow fadeInDown font-[600] md:font-[500] text-[24px] md:text-[32px] text-center leading-[52px] mb-[16px]">DeFi Academy</h3>
          ...
          <section className={`${events != "two" ? "hidden" : ""}`}>
            ...
            <h4 className="text-[#110138] wow fadeInDown font-[600] md:font-[500] text-[24px] md:text-[32px] text-center leading-[52px] mb-[16px]">Past Cohort</h4>
            <p className="md:w-[60%] wow fadeIn text-[#666481] text-[18px] font-[400] leading-[30px] md:leading-[28px] text-center mx-auto mb-[55px]">
                View our past skill up cohort
            </p>
            <div className={`md:grid wow fadeIn grid-cols-3 md:gap-x-[16px] space-y-[16px] md:space-y-0`}>
