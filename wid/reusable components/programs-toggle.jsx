    ...
    return (
      <section className="max-w-[1272px] pt-[67px] pb-[110px] w-[85%] mx-auto">
          ...
          <section className={`${events != "one" ? "hidden" : ""}`}>
            <h3 className="text-[#110138] wow fadeInDown font-[500] text-[32px] text-center leading-[52px] mb-[16px]">DeFi Academy</h3>
            <p className="w-[60%] wow fadeIn text-[#666481] text-[18px] font-[400] leading-[28px] text-center mx-auto">
          ...
          <section className={`${events != "two" ? "hidden" : ""}`}>
            <h3 className="text-[#110138] wow fadeInDown font-[500] text-[32px] text-center leading-[52px] mb-[16px]">Skill Up</h3>
            <p className="w-[60%] wow fadeIn text-[#666481] text-[18px] font-[400] mb-[116px] leading-[28px] text-center mx-auto">
            ...
            <h4 className="text-[#110138] wow fadeInDown font-[500] text-[32px] text-center leading-[52px] mb-[16px]">Past Cohort</h4>
            <p className="w-[60%] wow fadeIn text-[#666481] text-[18px] font-[400] mb-[40px] leading-[28px] text-center mx-auto">
                View our past skill up cohort
            </p>
            <div className={`grid wow fadeIn grid-cols-3 gap-x-[16px]`}>
