  ...
  return (
    ...
    >
      <div className="md:w-[50%] w-[90%] text-center mx-auto relative max-w-[609px] rounded-[16px] bg-[#FBFBFD] py-[100px] px-[16px] md:px-[32px] mt-[15vh]">
        ...
        <Image
          src="/images/no-event-img.svg"
          className="w-fit mx-auto"
          alt="no-event-img"
          height={1}
          width={100}
        />
        <h4 className="mt-[24px] text-[18px] font-[700] md:text-[24px] mb-[16px]">
          Oops!
        </h4>
        <p className="md:text-[16px] text-[15px] font-[500] leading-[20px]">
          We currently do not have any upcoming events, but not to worry you can
          check back soon.
        </p>
      </div>
    </section>
