          ...
          <section className="md:pt-[113px] pt-[70px] pb-[29px] md:pb-[99px] md:justify-between flex flex-col md:flex-row gap-[38px] md:gap-0 md:items-center max-w-[1272px] md:w-[85%] w-[90%] mx-auto">
            <div className="md:w-[49%]">
              ...
              <p className="text-[#666481] wow fadeIn text-[16px] md:text-[18px] font-[400] leading-[30px] md:leading-[26px]">
                All of our programs are thoughtfully crafted to empower African
                girls and women in the Blockchain space, equipping them with the
                essential technical and career skills necessary to advance in
                their respective domains. We operate as a non-profit
                organization, dedicated to supporting women in the Web3
                community.
              </p>
            </div>
            <figure className="relative bg-no-repeat bg-[url('/images/programs-q.png')] bg-cover bg-center wow fadeIn h-[491px] rounded-[24px] md:rounded-[100px] overflow-hidden md:w-[45%] max-w-[540px]"></figure>
          </section>
        </section>
        <ProgramToggle />
        <Testimonial />
