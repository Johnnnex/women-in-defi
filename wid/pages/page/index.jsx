        ...
        <section className="py-[64px] hidden md:block">
          <div className="max-w-[1272px] flex justify-between px-[24px] bg-[#0673EFCC] rounded-[24px] pt-[92px] pb-[70px] md:w-[85%] w-[90%] mx-auto">
            <div className="">
              ...
              <div className="flex gap-[20px] wow fadeInUp items-center">
                ...
                <a href="https://youtube.com/@womenindefi" className="hover:bg-[#00000045] transition-[.4s] rounded-[50%] p-1" target="_blank" rel="noopener noreferrer">
                  <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none">
