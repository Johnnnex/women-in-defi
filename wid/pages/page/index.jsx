          ...
          <section className="max-w-[1272px] md:w-[85%] w-[90%] pb-[30px] md:pb-[120px] mx-auto">
            ...
            <section className="md:block hidden">
              <div className="pt-[80px] wow fadeIn flex justify-between w-full">
                <figure className="w-[24%] bg-no-repeat bg-[url('/images/index-her-img.png')] bg-cover bg-center rounded-[16px] overflow-hidden h-[390px] relative">
                </figure>
                <div className="w-[24%] flex h-[390px] flex-col justify-between">
                  <figure className="w-full bg-no-repeat bg-[url('/images/hero-img-q-5.jpeg')] bg-cover bg-center h-[49%] rounded-[100px] overflow-hidden relative">
                  </figure>
                  <figure className="w-full bg-no-repeat bg-[url('/images/hero-img-q-4.jpeg')] bg-cover bg-center rounded-[100px] overflow-hidden h-[49%] relative">
                  </figure>
                </div>
                <div className="w-[24%] flex h-[390px] flex-col justify-between">
                  <figure className="w-full bg-no-repeat bg-[url('/images/her-img-q-3.png')] bg-cover bg-center h-[39%] rounded-[16px] overflow-hidden relative">
                  </figure>
                  <figure className="w-full bg-no-repeat bg-[url('/images/her-img-q-2.png')] bg-cover bg-center h-[59%] rounded-[16px] overflow-hidden relative">
                  </figure>
                </div>
                <div className="w-[24%] bg-no-repeat bg-[url('/images/hero-img-q-1.jpeg')] bg-cover bg-center h-[390px] rounded-[16px] overflow-hidden relative">
                </div>
              </div>
            </section>
            <ImgSlider
                  ...
                  <Link href="/page/programs">
                    <button className="py-[20px] text-[#0673EF] font-[500] md:text-[18px] text-[16px] hover:no-underline items-center underline flex">
                      ...
                      <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
                        <path d="M9.40997 20.4201L15.93 13.9001C16.7 13.1301 16.7 11.8701 15.93 11.1001L9.40997 4.58008" stroke="#0673EF" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
                      </svg>
                    </button>
                  </Link>
                </div>
              ...
              <a href="https://drive.google.com/drive/folders/1oglXz-N4YJRUwSpGSwvTF2HfZ80SaV0i" target="_blank" rel="noopener noreferrer">
                <button className="btn-trans flex items-center">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
                    <path d="M8.91003 20.4201L15.43 13.9001C16.2 13.1301 16.2 11.8701 15.43 11.1001L8.91003 4.58008" stroke="#0673EF" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                </button>
              </a>
            </div>
