      ...
      <main className="">
        <section className="pt-[80px] hero">
          <section className="md:pt-[113px] pt-[70px] pb-[29px] md:pb-[99px] md:justify-between flex flex-col md:flex-row gap-[38px] md:gap-0 md:items-center max-w-[1272px] md:w-[85%] w-[90%] mx-auto">
            ...
            <figure className="relative bg-no-repeat bg-[url('/images/programs-q.png')] bg-cover bg-center wow fadeIn h-[491px] rounded-[24px] md:rounded-[100px] overflow-hidden md:w-[45%] max-w-[540px]">
            </figure>
          </section>
        </section>
        <ProgramToggle />
