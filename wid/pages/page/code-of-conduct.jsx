...
const CodeOfConduct = () => {
  return (
    <>
        ...
        <main className="max-w-[1272px] md:pt-[113px] pt-[40px] md:w-[85%] w-[90%] mx-auto">
            <figure className="w-full h-[673px] mb-[40px] rounded-[8px] overflow-hidden relative">
                <Image
                    fill
            ...
            <h3 className="text-black font-[600] text-[40px] leading-[52px] mb-[40px]">Code of Conduct for Women In DeFi Community</h3>
            <article className="">
              <ol className="list-inside list-decimal">
                <li className="text-[#0673EF] text-[24px] font-[500] leading-[30px] mb-[16px]">Respect and Inclusion</li>
                <p className="text-[#666481] text-[18px] font-[400] leading-[30px] mb-[14px]">
                ...
                <li className="text-[#0673EF] text-[24px] font-[500] leading-[30px] mb-[16px]">Harassment-Free Zone</li>
                <p className="text-[#666481] text-[18px] font-[400] leading-[30px] mb-[14px]">
                ...
                <li className="text-[#0673EF] text-[24px] font-[500] leading-[30px] mb-[16px]">Constructive Communication</li>
                <p className="text-[#666481] text-[18px] font-[400] leading-[30px] mb-[14px]">
                ...
                <li className="text-[#0673EF] text-[24px] font-[500] leading-[30px] mb-[16px]">Privacy and Confidentiality</li>
                <p className="text-[#666481] text-[18px] font-[400] leading-[30px] mb-[14px]">
                ...
                <li className="text-[#0673EF] text-[24px] font-[500] leading-[30px] mb-[16px]">Professionalism</li>
                <p className="text-[#666481] text-[18px] font-[400] leading-[30px] mb-[14px]">
                ...
                <li className="text-[#0673EF] text-[24px] font-[500] leading-[30px] mb-[16px]">Intellectual Property</li>
                <p className="text-[#666481] text-[18px] font-[400] leading-[30px] mb-[14px]">
                ...
                <li className="text-[#0673EF] text-[24px] font-[500] leading-[30px] mb-[16px]">Compliance with Applicable Laws</li>
                <p className="text-[#666481] text-[18px] font-[400] leading-[30px] mb-[14px]">
                ...
                <li className="text-[#0673EF] text-[24px] font-[500] leading-[30px] mb-[16px]">No Solicitation or Spam</li>
                <p className="text-[#666481] text-[18px] font-[400] leading-[30px] mb-[14px]">
                  Avoid unsolicited promotion or spamming of products, services, or events. Self-promotion should be relevant and appropriate.
                </p>
                <li className="text-[#0673EF] text-[24px] font-[500] leading-[30px] mb-[16px]">Reporting Violations</li>
                <p className="text-[#666481] text-[18px] font-[400] leading-[30px] mb-[14px]">
                ...
                <li className="text-[#0673EF] text-[24px] font-[500] leading-[30px] mb-[16px]">Enforcement of the Code</li>
                <p className="text-[#666481] text-[18px] font-[400] leading-[30px] mb-[14px]">
            ...
            <div className="text-[18px] mb-[40px] font-[400] text-[#666481]">
